...
public class Config {
    ...
    public static String NOTES_DIRECTORY = System.getProperty("user.home") + "/noteVault/";  // Sets the NOTES_DIRECTORY (where my notes are saved) to the /noteVault directory created in home
